...
namespace ContosoUniversity.Controllers
{
    public class StudentController : Controller
    {
        ...
        //Если правильно разобрался, то бинд не позволяет хакерам добавить поле в бд извне. 
        ...
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        // Сгенерированный метод не годится. Причина - бинд очищает поля, не участвующие в привязке, что не
        // подохдит для обновления бд.
        ...
        // Если произойдет ошибка, метод вызовет Get - версию, но в таком случае там отобразится
        // захардкоженная ошибка.
